 ...
 */
declare function filterItems<TInput extends readonly unknown[]>(action: ArrayRequirement<TInput>): FilterItemsAction<TInput>;
 ...
 */
declare function findItem<TInput extends readonly unknown[]>(action: ArrayRequirement<TInput>): FindItemAction<TInput>;
 ...
 */
interface MapItemsAction<TInput extends readonly unknown[], TOutput extends readonly unknown[]> extends BaseTransformation<TInput, TOutput, never> {
    /**
     * The action type.
     */
 ...
 */
declare function mapItems<TInput extends readonly unknown[], TOutput>(action: ArrayAction$2<TInput, TOutput>): MapItemsAction<TInput, TOutput[]>;
 ...
 */
declare function reduceItems<TInput extends readonly unknown[], TOutput>(action: ArrayAction$1<TInput, TOutput>, initial: TOutput): ReduceItemsAction<TInput, TOutput>;
 ...
 */
declare function sortItems<TInput extends readonly unknown[]>(action?: ArrayAction<TInput>): SortItemsAction<TInput>;
 ...
 */
declare function transform<TInput, TOutput>(action: (input: TInput) => TOutput): TransformAction<TInput, TOutput>;
 ...
 * @returns A transform action.
 */
declare function transformAsync<TInput, TOutput>(action: (input: TInput) => Promise<TOutput>): TransformActionAsync<TInput, TOutput>;
